...
class Controller(QObject):
	...
	"""
	def run(self, program_path, input_path, config_data):	
		...
		self.operationhandler = OperationHandler(program_path, input_path, verbose=config_data.verbose, timeout=config_data.timeout, iterations=config_data.iterations)
